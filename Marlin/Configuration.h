...
#define STRING_CONFIG_H_AUTHOR "(Roland Gaida, Anet A8 Plus)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // (measured after M106 S255 with M303 E0 S210 C8)
    ...
    #define DEFAULT_Ki_LIST {   2.35,   2.35 }
    #define DEFAULT_Kd_LIST {  87.46,  87.46 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // *** insulated bed ***
  #define DEFAULT_bedKp 188.62
  #define DEFAULT_bedKi 37.14
  #define DEFAULT_bedKd 638.65
